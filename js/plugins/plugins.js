...
!function(e) {
    e.simpleTicker = function(t, i) {
        ...
        t = t;
        c.init = function() {
            switch (c.settings = e.extend({}, s, i),
            n.ul = t.children("ul"),
            n.li = t.find("li"),
        ...
        c.effect.exec = function() {
            n.initList.css(n.effect.init.css).animate(n.effect.init.animate, c.settings.speed, c.settings.easing).addClass(n.tickerHook),
            t.find(n.li).length > 1 && setInterval(function() {
...
!function() {
    ...
    t.prototype = {
        ...
        run: function() {
            ...
            t.context.fillText(t.loaded + "%", .5 * t.width, .5 * t.height + 2, t.width),
            t.context.beginPath(),
